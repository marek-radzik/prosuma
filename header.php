			...
			<?php if (is_front_page() && is_home()) { ?>
				...
				<?php } else { ?>
					...
					<div class="col-md-3 text-center mt-2">
						<button class="btn btn-outline-success  mr-2 btn-sign"><span class="img-sign"></span> <?php esc_html_e('Jetzt Personal anfragen', 'mr-theme'); ?></button><button class="btn polish-flag mt-2"><img src="<?php echo get_template_directory_uri(); ?>/img/poland.png" alt="pro-suma.com polish language" /></button>
					</div>
					</nav>
		</header><!-- #masthead -->